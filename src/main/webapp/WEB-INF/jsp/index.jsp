...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<form id="typeselectform" action="${pageContext.request.contextPath}/food/type" method="get">
							...
							<c:forEach items="${listFood}" var="food">
								<li class="list-group-item" id="${food.id}">
									...
									<div class="row">
										...
										<div class="col">
											<form action="${pageContext.request.contextPath}/food/updatefavorite" method="post">
												<input type="hidden" value="${food.id}" name="foodID" />
								...
								<form id="addfoodform" action="${pageContext.request.contextPath}/food/add" method="post">
									<div class="form-group">
										<label for="nameinput">Name:</label> <input type="text"
											class="form-control" id="nameinput" name="nom"></input>
									</div>
									<div class="form-group">
